...
const coinbase = createCoinbaseQuery("COMP-USD", getMetric("comp", "comp_price").timeframes)
const binance = createBinanceQuery("COMPUSDT", getMetric("comp", "comp_price").timeframes)
